...
public class SoloGamePanel {
	...
	private void initialize() {
		...
		comboBox_6.setModel(new DefaultComboBoxModel(new String[] {"aggressive ", "benevolent ", "random ", "cheater "}));
		comboBox_6.setBounds(500, 107, 102, 21);
		panel.add(comboBox_6);
		
		JComboBox comboBox_7 = new JComboBox();
		comboBox_7.setModel(new DefaultComboBoxModel(new String[] {"aggressive ", "benevolent ", "random ", "cheater "}));
		comboBox_7.setBounds(500, 157, 102, 21);
		panel.add(comboBox_7);
		
		JComboBox comboBox_8 = new JComboBox();
		comboBox_8.setModel(new DefaultComboBoxModel(new String[] {"aggressive ", "benevolent ", "random ", "cheater "}));
		comboBox_8.setBounds(500, 207, 102, 21);
		panel.add(comboBox_8);
		
		JComboBox comboBox_9 = new JComboBox();
		comboBox_9.setModel(new DefaultComboBoxModel(new String[] {"aggressive ", "benevolent ", "random ", "cheater "}));
		comboBox_9.setBounds(500, 260, 102, 21);
		panel.add(comboBox_9);
		
		JComboBox comboBox_10 = new JComboBox();
		comboBox_10.setModel(new DefaultComboBoxModel(new String[] {"aggressive ", "benevolent ", "random ", "cheater "}));
		comboBox_10.setBounds(500, 307, 102, 21);
		panel.add(comboBox_10);
		
		JComboBox comboBox_11 = new JComboBox();
		comboBox_11.setModel(new DefaultComboBoxModel(new String[] {"aggressive ", "benevolent ", "random ", "cheater "}));
