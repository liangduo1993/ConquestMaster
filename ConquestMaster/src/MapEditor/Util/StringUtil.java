...
public class StringUtil {
	...
	public static boolean parseBoolean(String str, boolean def) {
		...
		if ((str.toLowerCase().equals("true")) || (str.toLowerCase().equals("t")) || (str.toLowerCase().equals("yes"))
				|| (str.toLowerCase().equals("y"))) {
			return true;
		}
		if ((str.toLowerCase().equals("false")) || (str.toLowerCase().equals("f")) || (str.toLowerCase().equals("no"))
