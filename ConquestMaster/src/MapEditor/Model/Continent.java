...
/**
 * 
 * This class create methods set and get Continents names and bonus and  override the continents toString method.
 *
 */
public class Continent {
	 ...
	 * @param bonus input a bonus that want to set 
	 */
	 ...
	 * @param name input a continent name that want to set
	 */
